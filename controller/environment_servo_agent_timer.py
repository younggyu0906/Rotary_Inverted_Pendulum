...
class Env:
    ...
    def reset(self):
        ...
        wait_time = 1 if self.episode == 0 else 20# if self.episode % 10 == 0 else 3
    ...
    def __isDone(self):
        if self.steps >= 12000:# len(self.pendulum_radians) > 500 and abs(np.mean(self.pendulum_radians[-500:])) < 3.14 / 18:
            return True, "*** Success!!! ***"
