    ...
    def on_message(self, client, useradta, msg):
        ...
        if msg.topic == MQTT_SUB_FROM_ENV_MOTOR_POWER:
            ...
            if info[0] == 'done':
                ...
                print("--------------------------------")
                # LED Red + Green + Blue
                self.protection(0x03, 0xe7, 0x03, 0xe7, 0x03, 0xe7, 0)
            else:
                ...
                # LED Green
                previous_motor_angle, _, _, _ = self.send_and_receive(0x00, 0x00, 0x03, 0xe7, 0x00, 0x00, motor_power)

                # for next state
                time.sleep(SAMPLE_TIME)

                # LED Green
                _, motor_radian, _, pendulum_radian = self.protection(0x00, 0x00, 0x03, 0xe7, 0x00, 0x00, motor_power)
        ...
        while True:
            ...
            if currentTime - previousTime >= SAMPLE_TIME:
                ...
                motor_angle, motor_radian, pendulum_angle, pendulum_radian = \
                    self.send_and_receive(0x00, 0x00, 0x03, 0xe7, 0x03, 0xe7, 0)

                if -15 < pendulum_angle < 5:
                    break
                ...
                if pendulum_angular_velocity < 0:
                    ...
                    # LED Green + Blue
                self.send_and_receive(0x00, 0x00, 0x03, 0xe7, 0x03, 0xe7, int(motorPWM))
    ...
    def balance_control_by_manual(self):
        ...
        while count < 3000:
            ...
            if currentTime - previousTime >= SAMPLE_TIME:
                ...
                # LED Blue
                _, theta, _, alpha = self.send_and_receive(0x00, 0x00, 0x00, 0x00, 0x03, 0xe7, 0)
