...
if __name__ == "__main__":
    ...
    while True:
        # LED Green
        _, theta, alpha = servo.send_and_receive(0x00, 0x00, 0x03, 0xe7, 0x00, 0x00, int(motorPWM))
